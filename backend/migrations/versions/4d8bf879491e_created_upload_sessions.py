...
down_revision: str | Sequence[str] | None = "7d79f24cb107"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("storage_region", sa.Enum("US", "EU", "ITAR", name="storageregion"), nullable=False),
        sa.PrimaryKeyConstraint("upload_id"),
        sa.UniqueConstraint("link_uuid", "blob_name", name="uq_upload_blob_name_per_link"),
        schema="LinkDB",
    )

    op.create_index(op.f("ix_LinkDB_upload_sessions_link_uuid"), "upload_sessions", ["link_uuid"], unique=False, schema="LinkDB")

    op.create_index(op.f("ix_LinkDB_upload_sessions_upload_token"), "upload_sessions", ["upload_token"], unique=True, schema="LinkDB")


def downgrade() -> None:
    """Downgrade schema."""

    op.drop_index(op.f("ix_LinkDB_upload_sessions_upload_token"), table_name="upload_sessions", schema="LinkDB")

    op.drop_index(op.f("ix_LinkDB_upload_sessions_link_uuid"), table_name="upload_sessions", schema="LinkDB")

    op.drop_table("upload_sessions", schema="LinkDB")
